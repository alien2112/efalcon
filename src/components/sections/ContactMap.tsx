...
export function ContactMap() {
  ...
  return (
    <section ref={mapRef} className="pt-12 md:pt-16">
      {/* Section Header (contained) */}
      <div className="max-w-[1280px] mx-auto px-4 md:px-8">
        <div className="text-center mb-6 md:mb-8">
          <h2 className="font-['Alfa_Slab_One:Bold',_sans-serif] font-bold text-[28px] md:text-[40px] text-[#EFC132] mb-3">
            {language === 'ar' ? 'موقعنا' : 'Our Location'}
          </h2>
          <p className="font-['ADLaM_Display:Regular',_sans-serif] text-[15px] md:text-[18px] text-gray-600 max-w-[768px] mx-auto">
      ...
      <div className="relative w-[100vw] left-1/2 -translate-x-1/2">
        <div 
          className={`w-full h-[500px] md:h-[600px] bg-gray-200 overflow-hidden transition-all duration-1000 ${
        ...
        {/* Map Info Overlay */}
        <div className="absolute bottom-4 left-4 right-4 md:left-auto md:right-6 md:w-80 md:max-w-sm">
