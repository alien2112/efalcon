    ...
    <div className="relative w-full bg-[#716106] py-20 md:py-32 overflow-hidden">
      <div className="relative z-10 max-w-[1280px] mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-8">
          <Skeleton className="h-[48px] md:h-[72px] w-[300px] md:w-[400px] mx-auto mb-4 bg-gray-200" />
        </div>

        {/* Subtitle Skeleton */}
        <div className="text-center mb-16">
          <Skeleton className="h-[32px] md:h-[72px] w-[600px] md:w-[800px] mx-auto bg-gray-200" />
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute left-[-50px] md:left-[-100px] top-1/2 -translate-y-1/2 z-20">
            <Skeleton className="w-8 h-8 md:w-12 md:h-12 bg-gray-200 rounded-full" />
          </div>
          ...
          <div className="relative h-[400px] md:h-[492px] flex items-center justify-center">
            ...
            <div className="absolute left-0 md:left-[-100px] top-1/2 -translate-y-1/2 w-[150px] md:w-[297px] h-[150px] md:h-[277px]">
              <Skeleton className="w-full h-full rounded-[16px] bg-gray-200" />
            </div>
          ...
          <div className="mt-12 text-center">
            <Skeleton className="h-[24px] md:h-[36px] w-[400px] md:w-[500px] mx-auto mb-4 bg-gray-200" />
            <Skeleton className="h-[16px] md:h-[20px] w-[500px] md:w-[600px] mx-auto mb-6 bg-gray-200" />
            <Skeleton className="h-[16px] w-[120px] mx-auto bg-gray-200" />
          </div>
        </div>
      </div>
    </div>
            ...
            <div key={index} className="group relative rounded-[20px] overflow-hidden bg-black/20">
              ...
              <div className="absolute inset-x-0 bottom-0 p-0">
                <div className="bg-white/20 px-4 py-3 md:px-5 md:py-3">
                  <Skeleton className="h-[16px] md:h-[18px] w-[80%] bg-gray-200" />
                </div>
              </div>
            </div>
          ))}
