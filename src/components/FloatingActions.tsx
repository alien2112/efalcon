...
export function FloatingActions() {
  ...
  return (
    <div className="fixed right-2 md:right-4 bottom-4 z-[70] flex flex-col items-end gap-2 md:gap-3">
      {/* Call Button */}
      <a
        href="tel:+966565145666"
        aria-label="Call us"
        className="group shadow-lg rounded-full p-1 bg-[#25D366] hover:bg-[#128C7E] transition-colors duration-200 w-12 h-12 md:w-auto md:h-auto flex items-center justify-center"
      >
      ...
      <button
        ...
        className={`transition-opacity duration-300 ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'} bg-gradient-to-r from-[#EFC132] to-[#8B7A0A] text-white hover:shadow-xl transition-all duration-300 group shadow-lg rounded-full w-10 h-10 md:w-10 md:h-10 flex items-center justify-center`}
      >
